...
- [`user_web_workbench_guide.md`](user_web_workbench_guide.md)：网页工作台。
- [`api_usage_examples.md`](api_usage_examples.md)：HTTP、CLI 与 SDK 示例。
- [`developer_guide.md`](developer_guide.md)：开发、评测和扩展边界。
- [`deployment.md`](deployment.md)：本地与容器部署。
- [`demo_workflow.md`](demo_workflow.md)：演示流程。
- [`package_spec.md`](package_spec.md)：成果包契约。
- [`external_uir_integration.md`](external_uir_integration.md)：External UIR。
- [`lineage.md`](lineage.md)：SchemaPack-Lineage schema、API 与评测。
