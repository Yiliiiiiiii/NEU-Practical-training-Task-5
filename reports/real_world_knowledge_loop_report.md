...
| --- | --- | --- | --- | --- |
| approve | 采购方名称 | buyer_name | activated | 采购方名称与采购人语义一致，可作为采购文档 buyer_name 的安全别名。 |
| reject | 最高限价 | winning_amount | review_only | 最高限价是预算/控制价，不是中标金额，不能激活到 winning_amount。 |
